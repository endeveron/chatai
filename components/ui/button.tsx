  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-border hover:bg-secondary text-foreground/75 hover:text-foreground',
        secondary:
          'bg-secondary/80 text-foreground/75 shadow-sm dark:shadow-transparent hover:bg-secondary hover:text-foreground',
